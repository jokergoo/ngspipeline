...
use CO::NGSPipeline::BSseq::BSMAP;
use CO::NGSPipeline::BSseq::Bismark;
use CO::NGSPipeline::BSseq::Bsmooth;
use CO::NGSPipeline::BSseq::BisSNP;
use CO::NGSPipeline::BSseq::methylCtools;
use CO::NGSPipeline::RNAseq::HTSeqGenie;
use CO::NGSPipeline::RNAseq::GeneFusion;
use CO::NGSPipeline::RNAseq::TopHat;
use CO::NGSPipeline::RNAseq::STAR;
use CO::NGSPipeline::RNAseq::GSNAP;

sub bsmap {
	my $self = shift;
	return CO::NGSPipeline::BSseq::BSMAP->new($self);
}

sub bismark {
	my $self = shift;
	return CO::NGSPipeline::BSseq::Bismark->new($self);
}

sub bsmooth {
	my $self = shift;
	return CO::NGSPipeline::BSseq::Bsmooth->new($self);
}

sub bissnp {
	my $self = shift;
	return CO::NGSPipeline::BSseq::BisSNP->new($self);
}

sub methylctools {
	my $self = shift;
	return CO::NGSPipeline::BSseq::methylCtools->new($self);
}


sub tophat {
	my $self = shift;
	return CO::NGSPipeline::RNAseq::TopHat->new($self);
}

sub star {
	my $self = shift;
	return CO::NGSPipeline::RNAseq::STAR->new($self);
}

sub gsnap {
	my $self = shift;
	return CO::NGSPipeline::RNAseq::GSNAP->new($self);
}

sub genefusion {
	my $self = shift;
	return CO::NGSPipeline::RNAseq::GeneFusion->new($self);
}
1;
